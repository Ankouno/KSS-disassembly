...
LoadDMATable:					;-----------| Routine to write DMA data from a table in A/X to $0100 (A = lower 16-bits, X = bank).
  ...
  .loop:						;			|
	...
	BIT $0000					;$00871D	||\ 
	BMI .onSNES					;$008720	|||
	JSL .DecompressData			;$008722	|||
	BRA .doneCall				;$008726	||| ...decompress the data given first.
  .onSNES:						;			|||
	LDA.w #.DecompressData		;$008728	|||
	LDX.w #.DecompressData>>16	;$00872B	|||
  ...
  .DecompressData:				;```````````| Called on the SNES for decompressing data.
	...
	PEA $007E					;$00874D	||
	PLB							;$008750	|/
	JSL DecompressData			;$008751	| Decompress the data.
	PLB							;$008755	|
...
DepressOnSNES:					;-----------| Alternative entry to the below routine when you know for sure you're on the SNES.
	...
	PHD							;$008895	|
	SEP #$20					;$008896	|
	BRA DecompressData_Start	;$008898	|

DecompressData:					;-----------| Routine to decompress data, using exhal decompression.
